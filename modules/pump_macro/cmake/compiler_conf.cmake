message("<pump::pump_macro> /modules/pump_macro/compiler_conf in")
set(pump_macro_INNER_COMPILE_FLAG )
set(pump_macro_INNER_LINK_FLAG )

# pump_macro code debug level: DEBUG(0) INFO(1) WARN(2) ERROR(3) CRITICAL(4) RELEASE(5)
set(debug_pump_macro 0)
if(${debug_pump_macro} LESS 1)
    set(Db_Flage -D_TEST_LEVEL_DEBUG -D_TEST_LEVEL_INFO -D_TEST_LEVEL_WARN -D_TEST_LEVEL_ERROR -D_TEST_LEVEL_CRITICAL)
elseif(${debug_pump_macro} LESS 2)
    set(Db_Flage -D_TEST_LEVEL_INFO -D_TEST_LEVEL_WARN -D_TEST_LEVEL_ERROR -D_TEST_LEVEL_CRITICAL)
elseif(${debug_pump_macro} LESS 3)
    set(Db_Flage -D_TEST_LEVEL_WARN -D_TEST_LEVEL_ERROR -D_TEST_LEVEL_CRITICAL)
elseif(${debug_pump_macro} LESS 4)
    set(Db_Flage -D_TEST_LEVEL_ERROR -D_TEST_LEVEL_CRITICAL)
elseif(${debug_pump_macro} LESS 5)
    set(Db_Flage -D_TEST_LEVEL_CRITICAL)
else(${debug_pump_macro} LESS 6)
    set(Db_Flage )
endif()
message("<pump::pump_macro> Debug: ${Db_Flage}")
set(pump_macro_INNER_COMPILE_FLAG ${pump_macro_INNER_COMPILE_FLAG} ${Db_Flage})
# add_compile_options(${Db_Flage} ${pump_macro_INNER_COMPILE_FLAG})

if(${CMAKE_GENERATOR} STREQUAL "Unix Makefiles")
    set(pump_macro_INNER_COMPILE_FLAG ${pump_macro_INNER_COMPILE_FLAG}
            -Wl,-rpath=. -Wno-write-strings -fPIC)
    if(${pump_macro_BUILD_FLAG} MATCHES "shared")
        set(pump_macro_INNER_COMPILE_FLAG ${pump_macro_INNER_COMPILE_FLAG}
                -DPUMP_MACRO_BUILD_DLL)
    endif()
    set(pump_macro_INNER_LINK_FLAG ${pump_macro_INNER_LINK_FLAG}
        -lpthread -lrt)
...
elseif(${CMAKE_GENERATOR} MATCHES "Visual Studio")
    ...
    if(${CMAKE_GENERATOR} STREQUAL "Visual Studio 14 2015")
        if(${pump_macro_BUILD_FLAG} MATCHES "shared")
            set(pump_macro_INNER_COMPILE_FLAG ${pump_macro_INNER_COMPILE_FLAG}
                    -DPUMP_MACRO_BUILD_DLL -DGLOG_NO_ABBREVIATED_SEVERITIES)
        endif()
...
message("<pump::pump_macro> /modules/pump_macro/compiler_conf out")