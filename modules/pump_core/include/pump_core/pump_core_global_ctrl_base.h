...
{
//public:
//    friend class CLogRecorderGuider;
public:
    CGlobalCtrlBase();
    ...
    static CLogRecorderGuider GetLogger();
...
private:
    ...
    ::Pump::Core::Thread::CMutex m_csLogRecorder; ///< log recorder locker

protected:
    static CGlobalCtrlBase * s_pGlobalCtrl; ///< Global resource instance.
    /**
     * Global instance RW locker. <b>s_rcsGlobalCtrl<\b> prevent to free s_pGlobalCtrl \
     ...
     */
    static ::Pump::Core::Thread::CRWLocker s_rcsGlobalCtrl;
