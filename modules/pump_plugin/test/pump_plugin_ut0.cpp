...
int PTEST_SCENE_NAME(PumpPluginScene000)::Init()
{
...
int PTEST_SCENE_NAME(PumpPluginScene000)::Cleanup()
{
...
pump_handle_t PTEST_SCENE_NAME(PumpPluginScene000)::GetLogHandle() const { return m_hLog; }
